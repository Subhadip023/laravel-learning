...
<body class=" flex min-h-screen ">
    ...
    <aside id="sideBar" class="  w-[15%] m-h-screen hidden bg-blue-900  text-white flex flex-col  justify-between duration-500">
    ...
    <section class="w-full"  id="mainManu">

        <div class="bg-gray-200 shadow-lg border-b-2 shadow-gray-500 p-3 flex items-center h-[7%] justify-between duration-300">

            <button id="sideBarController" class="scale-150 border hover:border-blue-500 duration-300 border-blue-800 rounded-full p-1 font-bold">
                
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short text-blue-800 scale-150" viewBox="0 0 16 16">
        ...
        <section class="h-[93%]">
            ...
            @endif
           <section class="w-[95%]  h-[98%] m-auto my-auto flex flex-wrap items-center justify-center">
            {{$slot}}
